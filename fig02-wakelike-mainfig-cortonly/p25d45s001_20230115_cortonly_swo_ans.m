...
sim_name = 'p25d45s001_20230115_cortonly_swo_i001';
...
axes(ha(1)); spy(data.PYdr_v_spikes(time_index_range,:)', '.k',  7); pbaspect auto; ha(1).XLabel.String = '';
axes(ha(2)); spy(data.PYso_v_spikes(time_index_range,:)', '.k',  7); pbaspect auto; ha(2).XLabel.String = '';
