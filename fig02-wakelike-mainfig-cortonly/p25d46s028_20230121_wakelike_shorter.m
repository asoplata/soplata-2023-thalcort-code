%{
inherited from p25d38s012_20230101_gA4_wakelike_new_seeds_i009
%}
...
'IN<-PYso',   'gAMPA',  1.0*(1 - 0.30 - 0.30);
'IN<-TC',     'gAMPA',  0.1*(1 - 0.30 - 0.30);

'TC<-PYso',   'gAMPA',  0.4*(1 - 0.30 - 0.30);
'TRN<-PYso',  'gAMPA',  0.2*(1 - 0.30 - 0.30);
