%{
sim_3_lowdose_run: Simulation Run file contains all
configuration required to run the low-dose propofol simulation
in publications P16W1 and P25W1. This only calculates the simulation,
runs the analyses, and saves the initial data; it does not clean or
plot the data.
...
simulator_options={
    ...
    'plot_functions', {@dsPlot, @dsPlot, @dsPlot, @dsPlot, @dsPlot,...
                       @dsPlot, @dsPlot, @dsPlot, @dsPlot},...                 % Which plot functions to call automatically
    ...
    'random_seed', 1121149,...     % What seed to use; use value 'shuffle' to randomize
...
% -------------------------------------------------------------------
data_3_lowdose = dsSimulate(spec,'vary',vary,simulator_options{:});
